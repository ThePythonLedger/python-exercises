...
> **Next step:** Run pytest. If `test_task_1` passes, open your test file and remove the `@pytest.mark.skip` decorator above `test_task_2`.
...
> **Next step:** Run pytest. If `test_task_2` passes, open your test file and remove the `@pytest.mark.skip` decorator above `test_task_3`.

### Task 3: Resolve Damage
* Define `damage_dealt` by subtracting `enemy_attack_power` from `player_attack_power`.

> **Next step:** Run pytest. If `test_task_3` passes, open your test file and remove the `@pytest.mark.skip` decorator above `test_task_4`.
...
> **Next step:** Run pytest. If `test_task_4` passes, open your test file and remove the `@pytest.mark.skip` decorator above `test_task_5`.
...
> **Next step:** Run pytest. If `test_task_5` passes, open your test file and remove the `@pytest.mark.skip` decorator above `test_task_6`.
...
> **Next step:** Run pytest. If `test_task_6` passes, congratulation, you have successfully passed this exercise.
